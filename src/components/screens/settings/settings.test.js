...
describe('Setting', () => {
  ...
  const props = {
    ...
    account: { token: 'F39', passphrase: 'sample_passphrase' },
    timerReset: jest.fn(),
  ...
  describe('With specific properties', () => {
    it('should disable 2nd passphrase when hardwareWallet', () => {
      const newProps = { ...props, account: { hwInfo: { deviceId: '123' }, token: 'F39' } };
    ...
    it('should render 2nd passphrase as active', () => {
      const account2ndPassphrase = { secondPublicKey: 'sample_public_key', token: 'F39' };

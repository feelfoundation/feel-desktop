...
describe('Form', () => {
  ...
  beforeEach(() => {
    ...
    props = {
      ...
      nextStep: jest.fn(),
      initialValue: {
        recipient: bookmarks.F39[0].address,
      },
    };
      ...
      wrapper = mount(<Form {...{
        ...
        history: {
          ...
          location: {
            ...
            search: `?recipient=${bookmarks.F39[0].address}`,
          },
        },
      }}
      />, options);
      expect(wrapper.find('input.recipient')).toHaveValue(bookmarks.F39[0].title);
    });
  });
  ...
  describe('Amount field', () => {
    ...
    it('Should show error feedback if wrong data is inserted', async () => {
      ...
      expect(wrapper.find('.amount Feedback')).toHaveText('Provide a correct amount of F39');

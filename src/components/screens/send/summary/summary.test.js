...
import { toRawF39 } from '../../../../utils/f39';
...
describe('Summary', () => {
  ...
  it('should render properly', () => {
    ...
    expect(wrapper.find('button.confirm-button')).toHaveText('Send 1.123 F39');
    expect(wrapper.find('.amount-summary')).toIncludeText('1.123 F39');
  });
  ...
  it('should show props.fields.fee.value and use it in transactionCreated if props.token is not F39', () => {
    const txFee = 12451;

...
class RequestF39 extends React.Component {
  constructor(props) {
    super();
  ...
  render() {
    ...
    return (
      <RequestWrapper copyLabel={t('Copy link')} copyValue={shareLink} t={t} title={t('Request F39')}>
        <span className={`${styles.label}`}>
          {t('Use the sharing link to easily request any amount of F39 from Feel users.')}
        </span>

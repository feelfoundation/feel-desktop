  ...
  const fields = Object.entries({
    id: {
      ...
      value: (
        <>
          ...
          <CopyToClipboard className="hideOnLargeViewPort" value={blockDetails.data.id ? blockDetails.data.id.replace(regex.f39AddressTrunk, '$1...$3') : ''} />
        </>
      ),
    },
    height: {
    ...
    date: {
      ...
      value: <DateTimeFromTimestamp
        ...
        token={tokenMap.F39.key} // btc is closed
      />,
    },
    generator: {

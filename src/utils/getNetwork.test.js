  ...
  describe('getNetworkIdentifier function', () => {
    ...
    it('Should return nethash for custom node', () => {
      const network = {
        name: 'Custom Node',
        networks: {
          F39: { nethash: '098f6bcd4621d373cade4e832627b4f6' },
        },
      };
      expect(getNetworkIdentifier(network)).toBe(network.networks.F39.nethash);
    });
  });
});

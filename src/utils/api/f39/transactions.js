...
import { toRawF39, fromRawF39 } from '../../f39';
...
const parseCustomFilters = filters => ({
  ...
  ...processParam(filters, 'amountFrom', 'minAmount', toRawF39),
  ...processParam(filters, 'amountTo', 'maxAmount', toRawF39),
});
...
export const create = (
  ...
  try {
    // const { networkIdentifier } = transaction.network.networks.F39;
    const networkIdentifier = transaction.network.networks.F39.nethash;
...
export const getTransactionFee = async ({
  ...
  const roundedValue = parseFloat(Number(fromRawF39(value)).toFixed(8));

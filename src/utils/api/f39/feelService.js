...
const feelServiceApi = {
  ...
  getTransactions: async (network, {
    ...
    searchParams: {
      ...
      ...(amountFrom && { min: transactions.utils.convertF39ToFellows(amountFrom) }),
      ...(amountTo && { max: transactions.utils.convertF39ToFellows(amountTo) }),
      ...searchParams,
    },
    network,
  }),
   ...
   * @param {String} network.networks.F39.nethash - if name is "Custom node"
